      ...
      <div className="dashboard-body">
        ...
        <aside className="sidebar">
          <ul>
            ...
            <li className={activeTab === 'team-form' ? 'active' : ''} onClick={() => setActiveTab('team-form')}>Team Form</li>
            <li className={activeTab === 'project-list' ? 'active' : ''} onClick={() => setActiveTab('project-list')}>Project List</li>
          </ul>
        </aside>
                ...
                <section className="content-card half-width">
                  ...
                  {studentData.project_title ? (
                    <>
                      ...
                      <p><strong>Status:</strong> <span className={`status-tag ${studentData.project_status}`}>{studentData.project_status}</span></p>
                    </>
                  ) : (
